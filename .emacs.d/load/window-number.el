...
(defvar window-number-control-mode-map nil
  "Keymap for the window number control mode.")
...
; define C-1 to switch to win 1, etc (C-0 = win 10)
(unless window-number-control-mode-map
  (setq window-number-control-mode-map (make-sparse-keymap))
  (window-number-define-keys window-number-mode-map "C-"))
...
(define-minor-mode window-number-control-mode
  "A global minor mode that enables use of the C- prefix to
